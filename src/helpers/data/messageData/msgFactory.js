...
const msgEditer = (msgKey, isEdited) => axios.patch(`${baseUrl}/messages/${msgKey}.json`, { isEdited });

const msgEditedMessage = (msgKey, message) => axios.patch(`${baseUrl}/messages/${msgKey}.json`, { message });
